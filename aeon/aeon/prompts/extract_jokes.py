...
class Response(BaseModel):
    joke: str = Field(
        ...,
        description="One or more sentences containing a joke from the input text."
    )
...
class Batch(BaseModel):
    items: list[Response] = Field(
        ...,
        description="A list of Responses (jokes) extracted from the input text."
    )
